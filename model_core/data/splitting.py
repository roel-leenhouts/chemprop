...
from model_core.data.datapoints import LazyMoleculeDatapoint, MoleculeDatapoint, ReactionDatapoint
...
def make_split_indices(
    ...
    split : SplitType | str, optional
        Split type, one of ~model_core.data.utils.SplitType, by default "random"
