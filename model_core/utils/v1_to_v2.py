...
from model_core.nn.agg import AggregationRegistry
from model_core.nn.message_passing import (
    AtomMessagePassing,
    BondMessagePassing,
    MulticomponentMessagePassing,
)
from model_core.nn.metrics import LossFunctionRegistry, MetricRegistry
from model_core.nn.predictors import PredictorRegistry
...
def convert_model_file_v1_to_v2(model_v1_file: PathLike, model_v2_file: PathLike) -> None:
    ...
    logger.warning(
        ...
        "v1 atom featurizer is `model_core.featurizers.atom.MultiHotAtomFeaturizer.v1()` and can be "
