...
class Aggregation(nn.Module, HasHParams):
    ...
    See also
    --------
    :class:`~model_core.v2.models.modules.agg.MeanAggregation`
    :class:`~model_core.v2.models.modules.agg.SumAggregation`
    :class:`~model_core.v2.models.modules.agg.NormAggregation`
    """
