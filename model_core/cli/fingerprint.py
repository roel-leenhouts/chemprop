...
from model_core.models import load_model
...
class FingerprintSubcommand(Subcommand):
    COMMAND = "fingerprint"
    HELP = "Use a pretrained model to calculate learned representations."
