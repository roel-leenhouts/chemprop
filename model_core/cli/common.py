...
from model_core.cli.utils import LookupAction
from model_core.cli.utils.args import uppercase
from model_core.featurizers import AtomFeatureMode, MoleculeFeaturizerRegistry, RxnMode
from model_core.utils.utils import is_cuikmolmaker_available
...
- ``V1``: Corresponds to the original legacy configuration
- ``V2``: Tailored for a broad range of molecules, this configuration encompasses all elements in the first four rows of the periodic table, along with iodine. It is the current default.
